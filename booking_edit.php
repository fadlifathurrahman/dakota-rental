...
if (strlen($_SESSION['ulogin']) == 0) {
	...
	<head>
		...
		<title>Pembayaran | DAKOTA Rental Mobil</title>
		<!--Bootstrap -->
			...
			<div class="container">
				<div class="user_profile_info">
					<div class="col-md-12 col-sm-10">
						<form method="post" action="update_sewa.php" name="sewa" onSubmit="return valid();"
							...
							<div class="form-group">
								<button class="btn btn-primary" type="submit" style="width: 300; font-size: 12pt;" name="submit">Simpan Bukti Pembayaran</button>
							</div>
						</form>
					</div>
				</div>
