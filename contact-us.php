...
if (isset($_POST['send'])) {
  ...
  if ($lastInsertId) {
    ...
    echo " <script> alert ('Pesan Terkirim. Kami akan menghubungi anda secepatnya.'); </script> ";
  } else {
...
<body>
  ...
  <section class="contact_us section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h3>Isi form untuk mengirim pesan kepada admin</h3>
          <?php if ($error) { ?>
          ...
          <div class="contact_form gray-bg">
            <form method="post">
              ...
              <div class="form-group">
                <button class="btn" type="submit" name="send" type="submit">Kirim <span class="angle_arrow"><i
              ...
              while ($result = mysqli_fetch_array($query1)) {
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="contact_info_m"><a href="">
                        <?php echo htmlentities($result['email_kami']); ?>
                      </a></div>
                  </li>
                  <li>
                    <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                    <div class="contact_info_m"><a href="">
                        <?php echo htmlentities($result['telp_kami']); ?>
                      </a></div>
                  </li>
                </ul>
              <?php }
