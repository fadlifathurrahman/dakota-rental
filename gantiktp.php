...
if (strlen($_SESSION['ulogin']) == 0) {
	...
	<head>
		...
		<title>Ganti KTP | DAKOTA Rental Mobil</title>
		<!--Bootstrap -->
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading">Gambar KTP Detail</div>
											...
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														<img src="image/id/<?php echo htmlentities($result['ktp']); ?>"
												...
												<div class="form-group">
													...
													<label class="col-sm-4 control-label">Upload Gambar KTP Baru<span
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-4">
														<button class="btn btn-primary" name="update"
															style="width: 150; font-size: 12pt;" type="submit">Simpan KTP Baru</button>
													</div>
												</div>
