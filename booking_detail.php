...
if (strlen($_SESSION['ulogin']) == 0) {
	...
	<head>
		...
		<title>Detail Penyewaan | DAKOTA Rental Mobill</title>
		<!--Bootstrap -->
						...
						<form method="post" name="sewa" onSubmit="return valid();">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="mobil"
									value="<?php echo $result['kode_booking']; ?>" readonly>
							</div>
							<input type="hidden" class="form-control" name="vid" value="<?php echo $vid; ?>" required>
							<div class="form-group">
								<label>Mobil</label>
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" name="fromdate" placeholder="From Date(dd/mm/yyyy)"
									value="<?php echo $result['tgl_mulai']; ?>" readonly>
							</div>
							<div class="form-group">
								<label>Tanggal Selesai</label>
								<input type="date" class="form-control" name="todate" placeholder="To Date(dd/mm/yyyy)"
									value="<?php echo $result['tgl_selesai']; ?>" readonly>
							</div>
							<div class="form-group">
								<label>Durasi</label>
							...
							<?php if ($result['status'] == "Menunggu Pembayaran") {
								...
								?>
								<b>*Silahkan transfer total biaya sewa ke
									<?php echo $resultrek['detail']; ?> maksimal tanggal
									<?php echo IndonesiaTgl($tglhasil); ?>.
								<?php
							} else {
							...
							<br /><br />
							<div class="form-group">
								<a href="detail_cetak.php?kode=<?php echo $kode; ?>" target="_blank"
								style="width: 300; font-size: 12pt;" class="btn btn-primary btn-xs">Cetak Detail Penyewaan</a>
							</div>
						</form>
					</div>
				</div>
