...
if (strlen($_SESSION['ulogin']) == 0) {
  ...
  <head>
    ...
    <title>Ganti Password | DAKOTA Rental Mobil</title>
    <!--Bootstrap -->
          ...
          <div class="col-md-12 col-sm-10">
            ...
            <form method="post" action="update-passwordact.php">
              <div class="form-group">
                ...
                <input class="form-control white_bg" name="mail" id="mail" type="hidden" value="<?php echo $mail; ?>"
                  required>
              ...
              <div class="form-group">
                <label class="control-label">Konformasi Password Baru</label>
                <input class="form-control white_bg" name="confirm" id="confirm" type="password" required>
              </div>
              <div class="form-group">
                <button style="width: 150; font-size: 12pt;" type="submit" class="btn">Simpan Password Baru<span class="angle_arrow"><i class="fa fa-angle-right"
