...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Laporan Pemasukan | Admin DAKOTA Rental Mobil</title>
			...
			<div class="content-wrapper">
				<div class="container-fluid">
						...
						<div class="panel-body">
							<form method="get" name="laporan" onSubmit="return valid();">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<label>&nbsp;</label><br />
										<input type="submit" name="submit" value="Lihat Laporan" class="btn btn-primary" style="width: 120px; font-size: 12pt;">
									</div>
								</div>
							</form>
						</div>
					...
					if (isset($_GET['submit'])) {
						...
						<div class="panel panel-default">
							<div class="panel-heading">Laporan Pemasukan
								<?php echo IndonesiaTgl($mulai); ?> sampai
								<?php echo IndonesiaTgl($selesai); ?>
							</div>
							<div class="panel-body">
						...
						<div class="form-group">
							<center>
							<a href="laporan_cetak.php?awal=<?php echo $mulai; ?>&akhir=<?php echo $selesai; ?>" target="_blank"
								class="btn btn-primary" style="width: 300px; font-size: 14pt;">Cetak Laporan</a>
							</center>
						</div>
					<?php } ?>
