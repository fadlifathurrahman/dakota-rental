...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Admin - DAKOTA CAR RENTAL</title>
		...
		<div class="ts-main-content">
			...
			<div class="content-wrapper">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
						 	<center> <h2 class="page-title">Dashboard Utama Admin</h2> </center>
							<div class="row">
								<div class="col-md-12">
									<div class="row">
												...
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-number h1 ">
															<?php echo htmlentities($bayar); ?>
														</div>
														<div class="stat-panel-title text-uppercase">Menunggu Pembayaran
														</div>
													</div>
												</div>
												<a href="sewa_bayar.php"
											...
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														...
														?>
														<div class="stat-panel-number h1 ">
															<?php echo htmlentities($konfir); ?>
														</div>
														<div class="stat-panel-title text-uppercase">Konfirmasi Pembayaran
														</div>
													</div>
												</div>
												<a href="sewa_konfirmasi.php"
													class="block-anchor panel-footer text-center">Rincian &nbsp; <i
														class="fa fa-arrow-right"></i></a>
											</div>
										</div>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														...
														?>
														<div class="stat-panel-number h1 ">
															<?php echo htmlentities($belum); ?>
														</div>
														<div class="stat-panel-title text-uppercase">Sedang Disewakan
														</div>
													</div>
												</div>
												<a href="sewa_kembali.php"
													class="block-anchor panel-footer text-center">Rincian &nbsp; <i
														class="fa fa-arrow-right"></i></a>
											</div>
										</div>
									...
									<div class="row">
											...
											<div class="panel panel-default">
												<div class="panel-body bk-warning text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-title text-uppercase">Jumlah Merk Mobil</div>
													</div>
												</div>
												<a href="merek.php" class="block-anchor panel-footer text-center">Rincian
										...
										<div class="col-md-4">
											<div class="panel panel-default">
												...
												<a href="mobil.php" class="block-anchor panel-footer text-center">Rincian
													&nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="panel panel-default">
												<div class="panel-body bk-warning text-light">
													<div class="stat-panel text-center">
														<?php
														$sql2 = "SELECT kode_booking FROM booking WHERE status='Selesai' or status='Sudah Dibayar'";
														...
														<div class="stat-panel-title text-uppercase">Total Penyewaan</div>
													</div>
												</div>
												<a href="sewa.php" class="block-anchor panel-footer text-center">Rincian
													&nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
									</div>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-title text-uppercase">Pesan Masuk</div>
													</div>
												</div>
