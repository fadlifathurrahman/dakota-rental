...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Edit Status Konfirmasi Pembayaran | Admin | DAKOTA Rental Mobil</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Edit Status Konfirmasi Pembayaran</h2>
										...
										<div class="panel-body">
											...
											<form method="post" class="form-horizontal" name="theform"
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="penyewa" class="form-control"
															value="<?php echo $result['nama_user']; ?>" required readonly>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="telp" class="form-control"
															value="<?php echo $result['telp']; ?>" required readonly>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-2 control-label">Alamat</label>
													<div class="col-sm-4">
														<textarea col="5" name="alamat" class="form-control"
															readonly><?php echo $result['alamat']; ?></textarea>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-2 control-label">Bukti Bayar</label>
													<div class="col-sm-4">
														<a href="../image/bukti/<?php echo $result['bukti_bayar']; ?>"
															target="_blank"><img
																src="../image/bukti/<?php echo $result['bukti_bayar']; ?>"
										...
										<div class="panel-body">
											<form>
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="namamobil" class="form-control"
															value="<?php echo $result['nama_mobil']; ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="driver" class="form-control"
															value="<?php echo format_rupiah($result['driver']); ?>" required
															readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="mulai" class="form-control"
															value="<?php echo IndonesiaTgl($result['tgl_mulai']); ?>"
															required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="biayamobil" class="form-control"
															value="<?php echo format_rupiah($biayamobil); ?>" required
															readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="selesai" class="form-control"
															value="<?php echo IndonesiaTgl($result['tgl_selesai']); ?>"
															required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="total" class="form-control"
															value="<?php echo format_rupiah($total); ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="durasi" class="form-control"
															value="<?php echo $result['durasi']; ?>" required readonly>
													</div>
												</div>
											</form>
										</div>
