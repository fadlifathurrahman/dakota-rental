...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Kelola Halaman | Admin | DAKOTA Rental Mobil</title>
			...
			<div class="content-wrapper">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							<center>
							<h2 class="page-title">Kelola Halaman User</h2>
							</center>
							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Kelola Halaman</div>
													...
													<div class="col-sm-4">
														<select name="menu1" class="form-control"
															...
															<option value="" selected="selected" class="form-control">
																***Pilih Halaman***</option>
															<option value="manage-pages.php?type=terms">Terms and Conditions
															</option>
