...
if (strlen($_SESSION['alogin']) == 0) {
	...
	<head>
		...
		<title>Edit Merk Mobil | Admin | DAKOTA Rental Mobil</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Edit Merk Mobil</h2>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form method="post" name="theform" class="form-horizontal"
												action="merekeditact.php" onSubmit="return valid(this);">
												<?php
												$id = $_GET['id'];
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control"
															value="<?php echo htmlentities($result['nama_merek']); ?>"
															name="brand" id="brand" required>
														<input type="hidden" class="form-control"
															value="<?php echo htmlentities($id); ?>" name="id" id="id"
															required>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-4">
														<button class="btn btn-primary" type="submit"
															style="width: 150px; font-size: 12pt;">Ubah Merk</button>
													</div>
												</div>
											</form>
										</div>
