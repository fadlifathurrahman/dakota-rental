...
if (strlen($_SESSION['ulogin']) == 0) {
	...
	<head>
		...
		<title>Ganti KK | DAKOTA Rental Mobil</title>
		<!--Bootstrap -->
											...
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														...
														<img src="image/id/<?php echo htmlentities($result['kk']); ?>"
												...
												<div class="form-group">
													...
													<label class="col-sm-4 control-label">Upload Gambar KK Baru<span
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-4">
														...
														style="width: 150; font-size: 12pt;"  type="submit">Simpan KK Baru</button>
													</div>
												</div>
